...
//        System.out.println(university.getDepartments()[1].getGroups()[0].avgForSubject(subject4));
//        System.out.println(university.getDepartments()[1].getGroups()[0].avgForSubject(subject5));
